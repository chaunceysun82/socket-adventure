...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "This is room No. 0, with brown wallpaper",
            "This is room No. 1, with green wallpaper",
            "This is room No. 2, with yellow wallpaper",
            "This is room No. 3, with red wallpaper"
            ][room_number]
    ...
    def get_input(self):
        ...
        self.input_buffer = received.decode("utf-8").strip()
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        dict = {("north", 0): 3, ("south", 3): 0, ("east", 0): 2, ("east", 1): 0, ("west", 0): 1, ("west", 2): 0}
        if (argument, self.room) in dict:
            self.room = dict.get((argument, self.room))
